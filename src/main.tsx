...
function Footer(){return <footer><div className="wrap footer-top"><div className="brand"><span className="seal">छ</span><span><b>शिवाजी महाराज संस्था</b><small>Preserving heritage, inspiring tomorrow.</small></span></div><p>छत्रपती शिवाजी महाराजांच्या विचारांना आणि स्वराज्याच्या मूल्यांना समर्पित.</p><span>© 2026 Shivaji Maharaj Sanstha</span></div></footer>}
function App(){const [lang,setLang]=useState<Lang>((localStorage.getItem('lang') as Lang)||'mr');const change=(l:Lang)=>{localStorage.setItem('lang',l);setLang(l)};return <><Header lang={lang} setLang={change}/><Routes><Route path="/" element={<Home lang={lang}/>}/><Route path="/donate" element={<Donate lang={lang}/>}/><Route path="/project" element={<Project lang={lang}/>}/><Route path="/transparency" element={<Transparency lang={lang}/>}/><Route path="/about" element={<Simple lang={lang} kind="about"/>}/><Route path="/activities" element={<Simple lang={lang} kind="activities"/>}/><Route path="*" element={<Home lang={lang}/>}/></Routes><Footer/></>};
